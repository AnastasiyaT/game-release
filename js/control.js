...
secondDice.addEventListener('click', getNumbDice2);	
	...
	function getNumbDice2() {
		...
		switch(x) {
			case 0:
				divText.innerHTML ='Итоговый выпавший символ <b>символ </b>(кубик слева???) <b>«'+ links[0]+'»</b>, чтобы получить итоговый символ, наведите курсор мыши на кубик справа и кликните по нему. ';
				secondDice.src="img/0.gif";
				break;
			case 1:
				divText.innerHTML ='Итоговый выпавший символ <b>символ </b>(кубик слева???) <b>«'+ links[1]+'»</b>, чтобы получить итоговый символ, наведите курсор мыши на кубик справа и кликните по нему. ';
				secondDice.src="img/1.gif";
				break;
			case 2:
				divText.innerHTML ='Итоговый выпавший символ <b>символ </b>(кубик слева???) <b>«'+ links[2]+'»</b>, чтобы получить итоговый символ, наведите курсор мыши на кубик справа и кликните по нему. ';
				secondDice.src="img/2.gif";
				break;
			case 3: 
				divText.innerHTML ='Итоговый выпавший символ <b>символ </b>(кубик слева???) <b>«'+ links[3]+'»</b>, чтобы получить итоговый символ, наведите курсор мыши на кубик справа и кликните по нему. ';
				secondDice.src="img/3.gif";
				break;
			case 4:
				divText.innerHTML ='Итоговый выпавший символ <b>символ </b>(кубик слева???) <b>«'+ links[4]+'»</b>, чтобы получить итоговый символ, наведите курсор мыши на кубик справа и кликните по нему. ';
				secondDice.src="img/4.gif";
				break;
			default:
				divText.innerHTML ='Итоговый выпавший символ <b>символ </b>(кубик слева???) <b>«'+ links[5]+'»</b>, чтобы получить итоговый символ, наведите курсор мыши на кубик справа и кликните по нему. ';
